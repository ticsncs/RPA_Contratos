 ...
 */
export async function runClientExportAutomation(status = 'Cortado', exportTemplate = 'RPA_Clientes_Cortados', fileName = 'clientes_cortados') {
    try {
...
/*// Ejemplo de uso:
(async () => {
    const filePath = await runClientExportAutomation('Cortado', 'RPA_Clientes_Cortados', 'clientes_cortados');
