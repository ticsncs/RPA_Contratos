...
exports.navigateToAccountingDashboard = navigateToAccountingDashboard;
const logger_1 = require("../../utils/logger");
const DEFAULT_TIMEOUT = 10000;
// Logger instance
const logger = new logger_1.Logger('accounting-export');
 ...
 */
async function navigateToAccountingDashboard(page) {
